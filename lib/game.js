...
var terminal = new Terminal('terminal', {welcome: 'Welcome to a Song of Zork and Fire. What difficulty would you like? Easy, Medium or Hard?'}, {
    execute: function (cmd, args) {
        ...
        if (cmd === "talk") {
            talkTo(args, gameState.currentLocationName, locationList, sentencesList);
        }
        ...
        if (cmd === "eat") {
            eat(args, gameState.inventory, gameState.health);
            healthCheck(gameState.health);
        }
        ...
        healUp(gameState.currentLocationName, gameState.health);
