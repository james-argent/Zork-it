function resize() {
    ...
    if (mapElement.classList.contains('expanded')) {
        ...
        if (document.getElementById('winMessage').classList.contains('hidden')) {
            document.getElementById('loseMessage').classList.remove('recenter')
        } else {
            document.getElementById('winMessage').classList.remove('recenter')
        }
    } else {
        //expand map
        ...
        if (document.getElementById('winMessage').classList.contains('hidden')) {
            document.getElementById('loseMessage').classList.add('recenter')
        } else {
            document.getElementById('winMessage').classList.add('recenter')
        }
    }
}
